...
def svm_classification(a,b,z):
    ...
    print("The Accuracy is {} with SVM {}".format(round(accuracy,2) , z))
    return pred_log,Y_test

category = 'linear'
pred_log,Y_test = svm_classification(X,y,category)
...
print("TPR  for year 2020 is {}  and TNR for year 2020 is {}".format( round(tpr,2), round(tnr,2)))

print('################# Labels buy and hold and trading Strategy with SVM linear ###########')
...
def svm_poly(a,b):
    ...
    print("The Accuracy is {} with SVM Polynomial for degree 2 ".format(round(accuracy,2)))
    return pred_log,Y_test


pred_log,Y_test = svm_poly(X,y)
